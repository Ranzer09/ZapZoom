...
//       const final_qty = req_quantity - cart_qty; 
// let total_qty;
// if (!product_qty) {
//   return;
// }
// if (req_quantity === cart_qty) {
//   return;
// }
// // If requested quantity is less than the cart quantity, reduce stock accordingly
// if (req_quantity < cart_qty) {
//   total_qty = product_qty - final_qty;
// } else {
//   // If requested quantity is greater than cart quantity, increase stock accordingly
//   total_qty = product_qty - req_quantity + cart_qty;
// }
...
function CartItem({_id,index}){
    ...
    const handleAdd=()=>
      {
        ...
        .then(cart => {
            ...
            return fetch(`/api/products/${_id}`,{
              method:'PATCH',
              body:JSON.stringify({...Product,qty:product_qty-req_quantity}),
    ...
    const handleDelete=()=>
    {
      ...
      if(confirmed) 
        {
          const total_qty = products.find(obj => obj._id === _id).qty+req_quantity;
          let Product={
            _id,
            name,
            price,
    ...
    return(
        <div className="cart-heading cart-items ">
           ...
           <div className="qty-div"> 
            ...
            <span className="cart-subtotal">₹{req_quantity>0?req_quantity*price:0}</span> 
            <span className="btns">
